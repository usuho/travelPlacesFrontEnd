  ...
  methods: {
    ...
    getCountryDescription(country) {
      const descriptions = {
        ...
        mauritius: '火山岛与珊瑚礁环抱的海岛天堂，海滩与多元文化共存。',
        seychelles: '花岗岩海岛与碧蓝浅湾，巨龟与椰影构成的自然秘境。',
        caboverde: '大西洋群岛的音乐与火山风景，海风与色彩交织。',
        botswana: '奥卡万戈三角洲与乔贝国家公园，野生动物的旷野王国。',
        namibia: '纳米布红沙与骷髅海岸，极简荒野的震撼之地。',
        tunisia: '地中海蓝白小镇与撒哈拉绿洲，北非与罗马遗迹交汇。',
        rwanda: '千丘之国的山地大猩猩与湖光雨林，宁静而鲜活。',
        tanzania: '塞伦盖蒂草原与乞力马扎罗，野生与雪峰同框。',
        kenya: '马赛马拉与火烈鸟湖，草原日落与野性呼唤。',
        zambia: '维多利亚瀑布与赞比西河，水汽与彩虹共舞。',
        ghana: '黄金海岸与热带海滩，节奏与笑容在此相遇。',
        senegal: '达喀尔的海风与粉红湖，西非艺术与活力交织。',
        uganda: '尼罗河源头与山地大猩猩，绿意与冒险同行。',
        gambia: '袖珍河国的红树林与河口鸟岛，慢节奏水上之旅。',
        benin: '沃都文化与海滨古城，西非历史与民俗交织。',
        togo: '海岸集市与高原村落，小而多样的西非风情。',
        cotedivoire: '可可与雨林海岸线，阿比让的都市脉动。',
        malawi: '非洲温暖之心，马拉维湖与友善人情。',
        mozambique: '印度洋海岸与珊瑚群岛，海风与葡语文化相伴。',
        lesotho: '高原王国的群山与峡谷，云端牧歌与骑马之旅。',
        eswatini: '山地王国与传统文化并存，小而精致的自然乐园。',
        ...
        fiji: '珊瑚礁与碧蓝泻湖环绕的海岛，潜水与慢生活天堂。',
        palau: '海底奇观与水母湖闻名的小岛群，清澈如玻璃。',
        cookislands: '南太平洋的温柔群岛，环礁与星空下的宁静假期。',
        niue: '世界最大珊瑚岛之一，海洞与鲸跃带来原始惊喜。',
        tonga: '鲸歌之国与友善岛民，海风与王国文化同在。',
        vanuatu: '活火山与蓝洞并存，南太平洋的冒险乐园。',
        solomonislands: '二战遗迹与原始海岛，潜水与文化交织。',
        micronesia: '千岛散落的蔚蓝海域，古老遗迹与海底世界并行。',
        marshallislands: '环礁与椰影相伴，宁静海域中的漂浮世界。',
        kiribati: '跨越赤道的珊瑚环礁群，极简海天一色。',
        nauru: '袖珍海岛的蓝色海岸与静谧生活。',
        tuvalu: '最亲海的群岛国家，日落与海风铺满天际。',
