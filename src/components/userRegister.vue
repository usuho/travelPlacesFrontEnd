...
const COUNTRY_TRANSLATIONS = {
  ...
  'china': '中国', 'colombia': '哥伦比亚', 'comoros': '科摩罗', 'congo': '刚果', 'costa rica': '哥斯达黎加', 'cook islands': '库克群岛',
  ...
  'nauru': '瑙鲁', 'nepal': '尼泊尔', 'netherlands': '荷兰', 'new zealand': '新西兰', 'nicaragua': '尼加拉瓜', 'niger': '尼日尔', 'niue': '纽埃',
