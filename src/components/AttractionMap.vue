  ...
  methods: {
    ...
    getDefaultView() {
      ...
      const presets = {
        ...
        fiji: { center: [-17.8, 178.0], zoom: 6 },
        palau: { center: [7.5, 134.6], zoom: 7 },
        cookislands: { center: [-21.2, -159.8], zoom: 7 },
        niue: { center: [-19.05, -169.87], zoom: 7 },
        tonga: { center: [-21.2, -175.2], zoom: 7 },
        vanuatu: { center: [-15.4, 167.0], zoom: 6 },
        solomonislands: { center: [-9.6, 160.2], zoom: 6 },
        micronesia: { center: [7.4, 150.6], zoom: 6 },
        marshallislands: { center: [7.1, 171.2], zoom: 7 },
        kiribati: { center: [1.5, 173.0], zoom: 5 },
        nauru: { center: [-0.52, 166.93], zoom: 8 },
        tuvalu: { center: [-7.1, 177.6], zoom: 7 },
        ...
        albania: { center: [41.1, 20.2], zoom: 7 },
        andorra: { center: [42.54, 1.59], zoom: 9 },
        armenia: { center: [40.1, 45], zoom: 7 },
        azerbaijan: { center: [40.1, 47.7], zoom: 6 },
        bhutan: { center: [27.5, 90.4], zoom: 7 },
        bosniaherzegovina: { center: [43.9, 17.7], zoom: 7 },
        brunei: { center: [4.5, 114.7], zoom: 7 },
        bulgaria: { center: [42.7, 25.5], zoom: 6 },
        costarica: { center: [8.4, -84.8], zoom: 6 },
        elsalvador: { center: [13.8, -88.9], zoom: 7 },
        georgia: { center: [42.3, 43.3], zoom: 6 },
        guatemala: { center: [15.8, -90.2], zoom: 7 },
        honduras: { center: [15.2, -86.2], zoom: 6 },
        india: { center: [21.1, 82.8], zoom: 5 },
        kosovo: { center: [42.6, 20.9], zoom: 7 },
        liechtenstein: { center: [47.16, 9.55], zoom: 8 },
        malta: { center: [35.94, 14.38], zoom: 9 },
        moldova: { center: [47, 28.4], zoom: 7 },
        monaco: { center: [43.74, 7.4], zoom: 8 },
        montenegro: { center: [42.7, 19.4], zoom: 7 },
        nepal: { center: [28.4, 84.1], zoom: 5 },
        nicaragua: { center: [12.9, -85.2], zoom: 6 },
        northmacedonia: { center: [41.6, 21.7], zoom: 7 },
        panama: { center: [8.4, -80.1], zoom: 6 },
        papuanewguinea: { center: [-6.5, 148.4], zoom: 5 },
        philippines: { center: [12.9, 121.8], zoom: 5 },
        poland: { center: [51.9, 19.1], zoom: 5 },
        romania: { center: [46, 25], zoom: 5 },
        sanmarino: { center: [43.94, 12.44], zoom: 8 },
        serbia: { center: [44.2, 20.9], zoom: 7 },
        slovenia: { center: [46.1, 14.9], zoom: 7 },
        ukraine: { center: [48.8, 31.1], zoom: 5 },
        ...
        mauritius: { center: [-20.3, 57.5], zoom: 7 },
        seychelles: { center: [-4.6, 55.5], zoom: 7 },
        caboverde: { center: [16.0, -24.0], zoom: 7 },
        botswana: { center: [-22.3, 24.7], zoom: 5 },
        namibia: { center: [-22.6, 17.1], zoom: 5 },
        tunisia: { center: [34.0, 9.0], zoom: 6 },
        rwanda: { center: [-1.9, 29.9], zoom: 7 },
        tanzania: { center: [-6.4, 34.9], zoom: 5 },
        kenya: { center: [0.2, 37.9], zoom: 5 },
        zambia: { center: [-13.5, 27.8], zoom: 5 },
        ghana: { center: [7.9, -1.0], zoom: 6 },
        senegal: { center: [14.5, -14.5], zoom: 6 },
        uganda: { center: [1.3, 32.3], zoom: 6 },
        gambia: { center: [13.4, -15.5], zoom: 7 },
        benin: { center: [9.3, 2.3], zoom: 6 },
        togo: { center: [8.6, 1.0], zoom: 6 },
        cotedivoire: { center: [7.5, -5.5], zoom: 6 },
        malawi: { center: [-13.3, 34.3], zoom: 6 },
        mozambique: { center: [-17.5, 35.5], zoom: 5 },
        lesotho: { center: [-29.6, 28.2], zoom: 7 },
        eswatini: { center: [-26.5, 31.5], zoom: 7 },
    ...
    _getCountryMeta(countryKey) {
      const map = {
        ...
        fiji:      { iso2: 'fj', viewbox: [177.0, -15.0, 179.9, -21.0], labelEn: 'Fiji' },
        palau:     { iso2: 'pw', viewbox: [131.1, 8.3, 134.7, 7.0], labelEn: 'Palau' },
        cookislands:{ iso2: 'ck', viewbox: [-161.1, -19.5, -157.0, -22.2], labelEn: 'Cook Islands' },
        niue:      { iso2: 'nu', viewbox: [-170.0, -18.9, -169.5, -19.6], labelEn: 'Niue' },
        tonga:     { iso2: 'to', viewbox: [-176.3, -18.5, -173.6, -22.4], labelEn: 'Tonga' },
        vanuatu:   { iso2: 'vu', viewbox: [166.5, -13.0, 170.3, -20.3], labelEn: 'Vanuatu' },
        solomonislands:{ iso2: 'sb', viewbox: [155.5, -5.0, 170.0, -12.3], labelEn: 'Solomon Islands' },
        micronesia:{ iso2: 'fm', viewbox: [138.0, 10.0, 163.0, 0.9], labelEn: 'Micronesia' },
        marshallislands:{ iso2: 'mh', viewbox: [160.8, 14.7, 172.5, 4.5], labelEn: 'Marshall Islands' },
        kiribati:  { iso2: 'ki', viewbox: [169.5, 4.7, 176.5, -3.9], labelEn: 'Kiribati' },
        nauru:     { iso2: 'nr', viewbox: [166.8, -0.5, 167.0, -0.6], labelEn: 'Nauru' },
        tuvalu:    { iso2: 'tv', viewbox: [176.0, -5.4, 179.9, -11.2], labelEn: 'Tuvalu' },
        ...
        albania:   { iso2: 'al', viewbox: [19.3, 42.7, 21, 39.6], labelEn: 'Albania' },
        andorra:   { iso2: 'ad', viewbox: [1.41, 42.65, 1.77, 42.43], labelEn: 'Andorra' },
        armenia:   { iso2: 'am', viewbox: [43.4, 41.3, 46.6, 38.9], labelEn: 'Armenia' },
        azerbaijan:{ iso2: 'az', viewbox: [44.8, 41.9, 50.6, 38.4], labelEn: 'Azerbaijan' },
        bhutan:    { iso2: 'bt', viewbox: [88.7, 28.4, 92.1, 26.7], labelEn: 'Bhutan' },
        bosniaherzegovina:{ iso2: 'ba', viewbox: [15.7, 45.3, 19.6, 42.6], labelEn: 'Bosnia and Herzegovina' },
        brunei:    { iso2: 'bn', viewbox: [114, 5.1, 115.4, 4], labelEn: 'Brunei' },
        bulgaria:  { iso2: 'bg', viewbox: [22.3, 44.2, 28.6, 41.2], labelEn: 'Bulgaria' },
        costarica: { iso2: 'cr', viewbox: [-87.1, 11.2, -82.6, 5.5], labelEn: 'Costa Rica' },
        elsalvador:{ iso2: 'sv', viewbox: [-90.1, 14.4, -87.7, 13.2], labelEn: 'El Salvador' },
        georgia:   { iso2: 'ge', viewbox: [40, 43.6, 46.7, 41], labelEn: 'Georgia' },
        guatemala: { iso2: 'gt', viewbox: [-92.2, 17.8, -88.2, 13.7], labelEn: 'Guatemala' },
        honduras:  { iso2: 'hn', viewbox: [-89.4, 17.4, -83.1, 13], labelEn: 'Honduras' },
        india:     { iso2: 'in', viewbox: [68.1, 35.5, 97.4, 6.7], labelEn: 'India' },
        kosovo:    { iso2: 'xk', viewbox: [20, 43.3, 21.8, 41.8], labelEn: 'Kosovo' },
        liechtenstein:{ iso2: 'li', viewbox: [9.48, 47.26, 9.62, 47.05], labelEn: 'Liechtenstein' },
        malta:     { iso2: 'mt', viewbox: [14.18, 36.08, 14.57, 35.8], labelEn: 'Malta' },
        moldova:   { iso2: 'md', viewbox: [26.6, 48.5, 30.1, 45.5], labelEn: 'Moldova' },
        monaco:    { iso2: 'mc', viewbox: [7.37, 43.76, 7.44, 43.72], labelEn: 'Monaco' },
        montenegro:{ iso2: 'me', viewbox: [18.4, 43.5, 20.4, 41.9], labelEn: 'Montenegro' },
        nepal:     { iso2: 'np', viewbox: [80, 30.4, 88.2, 26.3], labelEn: 'Nepal' },
        nicaragua: { iso2: 'ni', viewbox: [-87.7, 15, -82.7, 10.7], labelEn: 'Nicaragua' },
        northmacedonia:{ iso2: 'mk', viewbox: [20.4, 42.4, 23, 40.8], labelEn: 'North Macedonia' },
        panama:    { iso2: 'pa', viewbox: [-83.1, 9.6, -77.2, 7.2], labelEn: 'Panama' },
        papuanewguinea:{ iso2: 'pg', viewbox: [140.8, -1.3, 156, -11.6], labelEn: 'Papua New Guinea' },
        philippines:{ iso2: 'ph', viewbox: [117, 21.1, 126.6, 4.7], labelEn: 'Philippines' },
        poland:    { iso2: 'pl', viewbox: [14.1, 54.8, 24.1, 49.0], labelEn: 'Poland' },
        romania:   { iso2: 'ro', viewbox: [20.2, 48.3, 29.7, 43.7], labelEn: 'Romania' },
        sanmarino: { iso2: 'sm', viewbox: [12.39, 43.98, 12.49, 43.89], labelEn: 'San Marino' },
        serbia:    { iso2: 'rs', viewbox: [18.8, 46.2, 23, 42.2], labelEn: 'Serbia' },
        slovenia:  { iso2: 'si', viewbox: [13.4, 46.9, 16.5, 45.4], labelEn: 'Slovenia' },
        ukraine:   { iso2: 'ua', viewbox: [22.1, 52.4, 40.2, 45.2], labelEn: 'Ukraine' },
        ...
        colombia:  { iso2: 'co', viewbox: [-79.1, 13.7, -66.8, -4.3], labelEn: 'Colombia' },
        ...
        mauritius: { iso2: 'mu', viewbox: [57.2, -19.5, 57.9, -20.9], labelEn: 'Mauritius' },
        seychelles:{ iso2: 'sc', viewbox: [55.0, -3.7, 56.8, -5.8], labelEn: 'Seychelles' },
        caboverde: { iso2: 'cv', viewbox: [-25.4, 17.2, -22.6, 14.6], labelEn: 'Cabo Verde' },
        botswana:  { iso2: 'bw', viewbox: [19.9, -17.8, 29.4, -26.9], labelEn: 'Botswana' },
        namibia:   { iso2: 'na', viewbox: [11.7, -16.9, 25.3, -28.9], labelEn: 'Namibia' },
        tunisia:   { iso2: 'tn', viewbox: [7.5, 37.6, 11.9, 30.2], labelEn: 'Tunisia' },
        rwanda:    { iso2: 'rw', viewbox: [28.8, -1.0, 30.9, -2.8], labelEn: 'Rwanda' },
        tanzania:  { iso2: 'tz', viewbox: [29.3, -1.0, 40.5, -11.7], labelEn: 'Tanzania' },
        kenya:     { iso2: 'ke', viewbox: [33.9, 5.1, 41.9, -4.7], labelEn: 'Kenya' },
        zambia:    { iso2: 'zm', viewbox: [21.9, -8.2, 33.7, -18.1], labelEn: 'Zambia' },
        ghana:     { iso2: 'gh', viewbox: [-3.3, 11.2, 1.2, 4.7], labelEn: 'Ghana' },
        senegal:   { iso2: 'sn', viewbox: [-17.5, 16.7, -11.4, 12.3], labelEn: 'Senegal' },
        uganda:    { iso2: 'ug', viewbox: [29.5, 4.2, 35.0, -1.5], labelEn: 'Uganda' },
        gambia:    { iso2: 'gm', viewbox: [-16.8, 13.8, -13.7, 13.0], labelEn: 'Gambia' },
        benin:     { iso2: 'bj', viewbox: [0.8, 12.4, 3.9, 6.2], labelEn: 'Benin' },
        togo:      { iso2: 'tg', viewbox: [-0.1, 11.1, 1.8, 6.0], labelEn: 'Togo' },
        cotedivoire:{ iso2: 'ci', viewbox: [-8.6, 10.7, -2.5, 4.3], labelEn: "Cote d'Ivoire" },
        malawi:    { iso2: 'mw', viewbox: [32.7, -9.4, 35.9, -17.1], labelEn: 'Malawi' },
        mozambique:{ iso2: 'mz', viewbox: [30.2, -10.5, 40.8, -26.9], labelEn: 'Mozambique' },
        lesotho:   { iso2: 'ls', viewbox: [27.0, -28.6, 29.5, -30.7], labelEn: 'Lesotho' },
        eswatini:  { iso2: 'sz', viewbox: [30.8, -25.7, 32.1, -27.3], labelEn: 'Eswatini' },
        // Դδ֪ң viewboxؿն
    ...
    formatFavoriteDateLine(value) {
      return formatFavoriteDateLineValue(value);
    },
    getFavoriteDateWeekday(value) {
      return getFavoriteDateWeekdayLabel(value);
    },
    formatFavoriteDateHtml(text, weekday) {
      const safe = this.escapeHtml(text);
      const highlightedDate = safe.replace(/(\d+)/g, '<span class="popup-favorite-date-num">$1</span>');
      if (!weekday) return highlightedDate;
      return `${highlightedDate} <span class="popup-favorite-weekday">${this.escapeHtml(weekday)}</span>`;
    },
