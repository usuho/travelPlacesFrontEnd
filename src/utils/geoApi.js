...
function apiBaseCandidates() {
  ...
  try { if (import.meta && import.meta.env && import.meta.env.VITE_API_BASE) list.push(String(import.meta.env.VITE_API_BASE)); } catch (e) {}
...
export async function fetchJson(path, options) {
  ...
  if (lastApiBase) {
    ...
    if (i > 0) { bases.splice(i, 1); bases.unshift(lastApiBase); }
  }
